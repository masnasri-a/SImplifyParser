...
test.describe('Test Endpoint /campaign/verifyContent?isContentValid=true&subCampaignId=2122', () => {
	const auth = AUTH
	const expectResult = {};
	...
	test('Endpoint Test v1/campaign/verifyContent Response - 401 Unauthorize', async ({ request }) => {
		const Issues = await request.put('https://api.estidar.com/api/v1/campaign/verifyContent?subCampaignId=285&isContentValid=true');
