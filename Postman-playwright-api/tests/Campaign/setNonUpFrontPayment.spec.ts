...
test.describe('Test Endpoint /campaign/setNonUpFrontPayment?campaignId=2442', () => {
	const auth = AUTH
	const expectResult = {};
	...
	test('Endpoint Test v1/campaign/setNonUpFrontPayment Response - 401 Unauthorize', async ({ request }) => {
		const Issues = await request.put('https://api.estidar.com/api/v1/campaign/setNonUpFrontPayment?campaignId=208');
